...
ADropItemActor::ADropItemActor()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterial> Material(TEXT("/Script/Engine.Material'/Game/Team_4/Item/DropItemMaterial.DropItemMaterial'"));
...
void ADropItemActor::PlayerOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (OtherActor != nullptr && OtherActor != this && OtherComp != nullptr)
	{
		...
		{
			Player->GetDropWeapon(WeaponTier, WeaponType);
			Destroy();
		}
	}
}
...
void ADropItemActor::SetColor()
{
	...
	Sphere->SetScalarParameterValueOnMaterials(TEXT("Opacity"), 0.3f);
}
